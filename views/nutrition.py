...
other_restrictions = st.text_input("Otras restricciones dietéticas (si aplica)")
allergies = st.text_input("¿Tiene alguna alergia o alergias? Si no, deje este campo en blanco.")
...
another_type_of_food = st.text_input("Otro tipo de comida preferida (si aplica)")
